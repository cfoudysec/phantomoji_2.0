...
> Renders as one ghost. Tokenizes as every byte.
...
```bash
git clone https://github.com/<your-handle>/phantomoji
cd phantomoji
...
Built by [kryptokat](https://github.com/kryptokat) — purple team research.
